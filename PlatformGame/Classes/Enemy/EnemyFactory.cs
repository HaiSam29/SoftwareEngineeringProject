...
namespace PlatformGame.Classes.Enemy
{
    public class EnemyFactory
    {
        ...
        public EnemyFactory(ContentManager content, IGameConfig config)
        {
            _content = content;
            _config = config;
        ...
        public EnemyClass CreateEnemy(EnemyType type, Vector2 position, ITileCollisionProvider collision, int tileSize)
        {
            ...
            // NIEUW: Maak de movement strategy hier aan
            // (Als je later vliegende enemies hebt, kun je hier switchen op type)
